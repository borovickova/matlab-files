...
for loop_param  = 1:3
        ...
        % OTHER PARAMETERS
        param.muH = param0.muH_grid(loop_param);
    ...
    % SOLVE THE SURPLUS
        ...
        seval = ['save sol_betrand_02_' int2str(loop_param) '.mat param sol'];
        eval(seval)

    % STATIONARY DISTRIBUTION
        solve_stat_distribution_p0distr_bertrand
        seval = ['save sol_stat_betrand_02_' int2str(loop_param) '.mat param sol'];
        eval(seval);

    % SIMULATIONS
        simulations_p0distr_bertrand
        seval = ['save simul_betrand_02_' int2str(loop_param) '.mat param sol simul'];
        eval(seval);
