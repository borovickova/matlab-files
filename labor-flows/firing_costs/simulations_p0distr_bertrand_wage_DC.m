...
% SET WAGE
    % update wage due to an outside offer
    wage_accept_outside_offer     = current_surplus.*accept_offer(employed);
    wage_not_accept_outside_offer = poaching_surplus.*receive_offer(employed).*(1-accept_offer(employed));
    
    % update wage if rationality is violated
    % I need to calculate the surplus
