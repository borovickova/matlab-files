...
load sol_stat_betrand_09d_3.mat
...
for loop_param = 1:3
    ...
    seval = ['save sol_betrand_DC_d3' int2str(loop_param) '.mat param sol_DC param_benchmark sol_benchmark'];
    eval(seval)

    % STATIONARY DISTRIBUTION
    solve_stat_distribution_p0distr_bertrand_DC
    seval = ['save sol_stat_betrand_DC_d3' int2str(loop_param) '.mat param sol_DC param_benchmark sol_benchmark'];
    eval(seval);
    
    % SIMULATIONS
    simulations_p0distr_bertrand_DC
    seval = ['save simul_betrand_DC_d3' int2str(loop_param) '.mat param sol_DC param_benchmark sol_benchmark simul'];
    eval(seval);
